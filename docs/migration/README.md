...
| [adversarial-ledger-tunnel-editor.md](adversarial-ledger-tunnel-editor.md) | Tunnel editor dialog Fake VM glue (`TunnelEditorDialogVm` / `FakeTunnelEditorLab`) review closed |
...
| [adversarial-ledger-rdp-aad-external.md](adversarial-ledger-rdp-aad-external.md) | RDP Azure AD / external-client detection Fake glue (`RdpAadExternalClientGlue` / scripted catalog) review closed |
...
| [adversarial-ledger-import-dialog.md](adversarial-ledger-import-dialog.md) | mRemoteNG import dialog Fake VM glue (`MRemoteNgImportDialogVm` / Fake path pick + apply lab) review closed |
