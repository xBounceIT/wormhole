...
public sealed class AxMsRdpClient9NotSafeForScripting : AxHost
{
    ...
    public AxMsRdpClient9NotSafeForScripting() : this(SelectBestRegisteredClass())
    {
    }

    internal AxMsRdpClient9NotSafeForScripting(RdpActiveXClass activeXClass) : base(activeXClass.ClsidString)
    {
        ActiveXClass = activeXClass;
    }

    public string ActiveXClassName => ActiveXClass.Name;
    public string ActiveXClsid => ActiveXClass.ClsidString;
    ...
    private RdpActiveXClass ActiveXClass { get; }
    ...
    private static RdpActiveXClass SelectBestRegisteredClass() => GetRegisteredClasses()[0];
